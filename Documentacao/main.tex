...
\begin{longtable}{|>{\raggedright\arraybackslash}m{3.5cm}|>{\raggedright\arraybackslash}m{4cm}|>{\raggedright\arraybackslash}m{7.5cm}|}
    ...
    Product Owner & Raquel Correia da Silva & Definição e priorização do Product Backlog, validação das entregas, documentação.\\
    \hline
...
\begin{figure}[htb]
    \caption{Estrutura do Banco de Dados (MER)}
    \label{fig:mer_conceitual}
    \centering
    \includegraphics[width=0.9\textwidth]{Imagens/BD2.jpg}
...
\begin{figure}[htb]
    ...
    \centering
    % Atenção: Caminho corrigido para 'Imagens/' (raiz)
    \includegraphics[width=0.9\textwidth]{Imagens/BD.jpg}
    %\source{Autoria própria (2025)}
\end{figure}
